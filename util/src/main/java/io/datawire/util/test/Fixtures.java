...
public class Fixtures {
  ...
  public String getFixtureFilePath(String path) {
    URL fixture = Fixtures.class.getResource(path);
    try {
      return new File(fixture.toURI()).getAbsolutePath();
